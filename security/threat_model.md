...
- Structured-log integrity: the Rust engine encodes all JSON control characters before emitting caller-influenced fields, with unit coverage for the complete U+0000 through U+001F range.
