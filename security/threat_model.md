...
| Denial of Service | Auth, AI, journal, rooms, WebSockets, dependencies | Configurable route/socket abuse limits, bounded HTTP clients, WebSocket frame limits/deadlines, circuit breaker for Zoom, local load harness | Staging load test against real ingress/API/Redis/Postgres/AI, rate-limit observation under real client identity |
