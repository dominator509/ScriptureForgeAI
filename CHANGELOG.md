...
- Made AI provider environment values whitespace-safe: blank API keys fail closed before transport, while configured endpoint and model values are trimmed at construction.
