...
- Recorded hosted exact-SHA verification for the pinned-image code tip `89d71720552fa6a430558a2f4921bf03d5d8fcbe` in run `33282131872` (#723), documentation tip `4915f69cce74aa455f5c69ad1f9e929a2d7679cc` in run `33282396359` (#725), and current tip `9e0830879ec3fe8f45b5c8b5b3523d88c7f04481` in run `33283115656` (#727); staging artifact ingestion and deployment evidence remain external.
