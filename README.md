...
The provider and generation artifacts must be redacted; the probe rejects obvious API key or bearer-token leaks. A passing report includes `EXT-AI-001` in `evidence_items`.
