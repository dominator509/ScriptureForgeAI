...
The recorder rejects `DATA-RLS-001` reports that target local/non-HTTPS APIs, omit the owner/blocked journal probes, or do not include an HTTPS non-local database RLS artifact probe.
