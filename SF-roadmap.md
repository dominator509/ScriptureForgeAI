...
- Current clean local matrix (2026-08-27): exact SHA `0c63a86a32795f5692fd85d2bf1280ac8f8b2c43` executed 35/35 gates with 34 passing; only `rls-db-integration` failed because the Docker Desktop backend timed out after the service was started. The fail-closed DB gate remains required and no RLS proof claim is made from this run.
