...
- Current exact-release CI evidence (2026-08-17): commit `89927f50e3f6db324589f2f49e2981c51441e5eb` passed the clean `34/34` local gate matrix and hosted Security Pipeline Verification run `31999768770`; `tools/ciprobe` validated the release artifact as `SRC-CI-001`. Environment-specific staging-manifest ingestion and all deployed/staging evidence remain pending.
