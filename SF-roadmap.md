...
- Current exact-release CI verification (2026-08-29): latest behavior-changing hardening commit `93a54a8124f444d059538679ae492495da9d1e5c` passed push run `33196601954` and pull-request run `33196610386`, and the subsequent documentation-only synchronization commit `20f77dfdf7372374d54c601b1f3e053843f7ea3f` passed push run `33258277101` and pull-request run `33258281926`. Staging-manifest ingestion and deployed evidence remain pending.
