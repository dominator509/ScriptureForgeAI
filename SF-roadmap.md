...
- Current exact-release CI verification (2026-08-29): branch tip `f713d59288627a319af94b3429f496bdb16bc0e0` passed hosted Security Pipeline Verification pull-request run `33265510955`, including PostgreSQL/RLS, local gate runner, web/mobile, Rust, Terraform, secret scanning, source-control cleanliness, and CI release-evidence upload. Environment-specific staging-manifest ingestion and deployed evidence remain pending.
