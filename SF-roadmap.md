...
- Current exact-release CI verification (2026-08-29): branch tip `93a54a8124f444d059538679ae492495da9d1e5c` passed push run `33196601954` and pull-request run `33196610386`, including PostgreSQL/RLS integration, web/mobile, Rust, Terraform, secret scanning, clean-source verification, and CI release-evidence upload. Staging-manifest ingestion and deployed evidence remain pending.
