...
- Current exact-release CI verification (2026-08-29): latest behavior-changing hardening commit `c2501f85349dc00d80344cde831a54b0a9736757` passed hosted pull-request run `33259420498`, including the real PostgreSQL/RLS and CI release-evidence gates. Staging-manifest ingestion and deployed evidence remain pending.
