...
- Current exact-release CI verification (2026-08-29): branch tip `e348ea6df99c0daea57583f842058715aba17496` passed hosted Security Pipeline Verification pull-request run `33264213933`, including PostgreSQL/RLS, local gate runner, web/mobile, Rust, Terraform, secret scanning, source-control cleanliness, and CI release-evidence upload. Environment-specific staging-manifest ingestion and deployed evidence remain pending.
