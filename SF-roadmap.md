...
- Current exact-release CI evidence (2026-08-17): commit `a9214415f614b38945b0a08d354147c86bed314e` passed the clean `34/34` local gate matrix and hosted Security Pipeline Verification run `31994556821`; `tools/ciprobe` validated the release artifact as `SRC-CI-001`. Environment-specific staging-manifest ingestion and all deployed/staging evidence remain pending.
