...
const obsAPIMetricsPattern = /api-prometheus-metrics(?=[^;]*staging artifact)(?=[^;]*scriptureforge_http_requests_total)(?=[^;]*scriptureforge_http_request_duration_seconds_sum)(?=[^;]*scriptureforge_http_requests_total\{)(?=[^;]*status=)(?=[^;]*websocket_active_connections_count)(?=[^;]*scriptureforge_dependency_operations_total\{dependency="websocket",operation="room_broadcast",status="dropped")(?=[^;]*ai_inference_duration_seconds_sum)(?=[^;]*ai_inference_duration_seconds_count)(?=[^;]*scriptureforge_dependency_operations_total\{dependency="rust_engine",operation="vector_search",status="success")(?=[^;]*scriptureforge_dependency_operation_duration_seconds_sum\{dependency="rust_engine",operation="vector_search",status="success")(?=[^;]*release_candidate=)(?=[^;]*load_run_id=)/i;
...
const redisPerformanceSegmentMarkerRequirements = new Map([
  ['DATA-REDIS-001', ['staging artifact', 'profile=staging_websocket', 'release_candidate=', 'service_version=', 'load_run_id=', 'ws_room_id=', 'ws_reconnect_room_id=', 'ws_polling_room_id=', 'redis_telemetry_room_id=', 'ws_reconnect_sequence_continues=true', 'ws_sequence_contiguous=true', 'production_min_ws_events=30000', 'ws_expected_events=', 'ws_unique_sequences=', 'ws_min_sequence=1', 'ws_max_sequence=', 'ws_polling_latest_sequence=', 'redis_telemetry_artifact_url=https://']],
