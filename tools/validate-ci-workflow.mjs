...
export const requiredMarkers = [
  ...
  { id: 'ci-rust-toolchain', text: 'toolchain: 1.97.1' },
  { id: 'ci-kubectl-runner', text: 'command -v kubectl' },
  { id: 'ci-kubectl-version', text: 'kubectl version --client=true' },
  ...
  { id: 'disaster-recovery', text: 'node tools/validate-disaster-recovery.mjs' },
  { id: 'disaster-recovery-tests', text: 'node --test tools/validate-disaster-recovery.test.mjs' },
