...
const requiredObservabilityProbeSummaryMarkers = new Map([
  ...
  ['api-prometheus-metrics', ['staging artifact', 'scriptureforge_http_requests_total', 'scriptureforge_http_request_duration_seconds_sum', 'scriptureforge_http_requests_total{', 'status=', 'websocket_active_connections_count', 'scriptureforge_dependency_operations_total{dependency="websocket",operation="room_broadcast",status="dropped"', 'ai_inference_duration_seconds_sum', 'ai_inference_duration_seconds_count', 'scriptureforge_dependency_operations_total{dependency="rust_engine",operation="vector_search",status="success"', 'scriptureforge_dependency_operation_duration_seconds_sum{dependency="rust_engine",operation="vector_search",status="success"']],
  ['rust-prometheus-metrics', ['staging artifact', 'scriptureforge_rust_engine_embedding_requests_total', 'scriptureforge_rust_engine_embedding_failures_total', 'scriptureforge_rust_engine_vector_search_requests_total', 'scriptureforge_rust_engine_vector_search_failures_total']],
  ['trace-backend-search', ['staging artifact', 'scriptureforge-api', 'scriptureforge-rust-engine']],
  ['log-backend-trace-correlation', ['staging artifact', 'trace_id', 'scriptureforge-api', 'scriptureforge-rust-engine', 'service_version', 'deployment_environment', 'tenant_id=', 'user_id=', 'role=', 'distinct_otel_artifacts=true']],
