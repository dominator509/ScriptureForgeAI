...
export function validateRLSSchema(migrationText, tableRLSTestText, handlerRLSTestText, portHandlerRLSTestText = '', aiAuditRLSTestText = '', authSessionRLSTestText = '', authHandlerText = '') {
  assert.deepEqual(
...
async function main() {
  ...
  const result = validateRLSSchema(migrationText, tableRLSTestText, handlerRLSTestText, portHandlerRLSTestText, aiAuditRLSTestText, authSessionRLSTestText, authHandlerText);
